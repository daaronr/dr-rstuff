...
student_responses <-  "BEE2038 - results_irene_fixed.xlsx"
#student_responses <- "BEE2038 - data - not marked.xlsx"
#student_responses <- "bee2038-midterm-2019-extra-ilp.xlsx"

adhoc_adjust <- 5.8333333333

outfile <-  "bee2038_midterm_results_irene_fixed.csv"
outfile_uni_order <-  "bee2038_midterm_results_irene_fixed_uni_order.csv"
#outfile <-  "bee2038_midterm_results_extra_ilp.csv"
```
