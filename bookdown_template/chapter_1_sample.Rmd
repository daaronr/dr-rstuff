...
```{block2,  type='note'}
NOTE that the current bookdown just contains examples for illustrating the template. 

NOTE I (David Reinstein) am also likely to be switching many or all of my bookdowns to the 'Rethink Priorities' template (see https://github.com/rethinkpriorities/bookdown-template)
