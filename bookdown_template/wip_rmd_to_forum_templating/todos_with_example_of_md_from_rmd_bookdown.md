...
**Note: I include a series of 'todos' -- to be done either within the knitr command, or as a separate script. These are noted 'SCRIPT:'**
...
SCRIPT: remove/comment out all code blocks
